	...
	<form class="form-horizontal" method="post" action="" id="write_action">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="input-xlarge" id="input01" name="b_title" style="width: 100%"
						   value="<?php echo set_value('b_title');?>">
					<p class="help-block">게시물의 제목을 써주세요.</p>
				</div>
                <br>
				<label class="control-label" for="input02">내용</label>
				<div class="controls">
<textarea class="input-xlarge" id="input02" name="b_contents" rows="10" style="width: 100%">
<?php echo set_value('b_contents');?></textarea>
