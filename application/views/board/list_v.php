	...
	$(document).ready(function(){
		$("#search_btn").click(function(){  //검색 기능을 누르면
			if($("#q").val() == ''){
				...
				var act = '/capp/index.php/board/lists/f_board/q/'+$("#q").val()+'/page/1';
					...
					foreach ($list as $lt) {?>
						<tr>
							...
							<td><a rel="external" href="<?php echo base_url('/capp/index.php/');?><?php echo $this->uri->segment(1); ?>/view/<?php echo $this->uri->segment(3); ?>/<?php
								echo $lt-> b_id;?>/page/<?php echo $this->uri->segment(5);?> ">
									<?php echo $lt->b_title; ?></a></td>
                            <td><?php echo $lt->b_name; ?></td>
							<td><?php echo $lt->b_views; ?></td>
							<td><?php echo $lt->b_date; ?></td>
						</tr>
						<?php }?>
					<tr><th colspan="5"><a href="<?php echo base_url('/capp/index.php/board/write/');?><?php echo $this->uri->segment(3);?>/page/<?php echo $this->uri->segment(5);?>"
