...
<article class="w3-card w3-round w3-white" id="board_area">
	...
	<table cellspacing="0" cellpadding="0" class="table table-striped" >
		<thead>
		<tr>
			<th scope="col"> <?php echo $views->m_title; ?></th>
			<th scope="col">이름 : <?php echo $views->m_name; ?></th>
			<th scope="col">조회수 : <?php echo $views->m_views; ?></th>
			<th scope="col"> 등록일 : <?php echo $views->m_date; ?></th>
		</tr>
		</thead>
		<tbody>
		<tr>
			<th colspan="4" class="w3-padding-16" style="height: 300px"><?php echo $views->m_contents; ?></th>
		</tr>
		</tbody>
		<tfoot>
		<tr>
            <th colspan="4">
                <a href="<?php echo base_url('/capp/index.php/mboard/lists/');?><?php echo $this->uri->segment(3);?>"
                ...
                <?php if ($this->session-> userdata('user') == TRUE) {?>
                    ...
                    if($udata->uid == $views->uid) {?>
                        <a href="<?php echo base_url('/capp/index.php/mboard/modify/');?><?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>"
                           class="w3-button w3-round" style="border: 1px solid; border-color: darkgray">수정</a>
                        <a href="<?php echo base_url('/capp/index.php/mboard/delete/');?><?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>"
                ...
                <?php } else {?>
                    ...
                    <a></a>
                <?php }?>
                <a href="<?php echo base_url('/capp/index.php/mboard/write/');?><?php echo $this->uri->segment(3);?>"
            ...
            <form class="form-horizontal" method="POST" action="" id="comment_action" name="com_add">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="input01">답변</label>
                        <div class="controls">
