	...
	<form class="form-horizontal" method="post" action="" id="write_action">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="input-xlarge" id="input01" name="m_title" style="width: 100%" value="<?php echo $views->m_title;?>">
					<p class="help-block"></p>
				</div>
				<label class="control-label" for="input02">내용</label>
				<div class="controls">
					<textarea class="input-xlarge" id="input02" name="m_contents" rows="10" style="width: 100%"><?php echo $views->m_contents;?></textarea>
					<p class="help-block"></p>
				</div>
                <br>
